...
class Transform(DagNode):
    ...
    def shapes(self) -> "list[ShapeNode]":
        """Shape children for this transform.
    ...
    @property
    def mdag_path(self):
        """MDagPath handle for this transform node.
    ...
    def world_translation(self):
        """World translation of this transform's rotate pivot.
    ...
    def world_matrix(self):
        """World matrix of this transform node.
    ...
    @property
    def matrix(self):
        """Local matrix of this transform node.
    ...
    def parent_matrix(self):
        """Local matrix of this transform node's parent.
    ...
    @property
    def translate(self):
        """Local translation of this transform node.
    ...
    @property
    def rotate(self):
        """Local rotation of this transform node.
    ...
    @property
    def scale(self):
        """Local scale of this transform node.
    ...
    def translate_x(self):
        """X translation of this transform node.
    ...
    def translate_y(self):
        """Y translation of this transform node.
    ...
    def translate_z(self):
        """Z translation of this transform node.
    ...
    @property
    def rotate_x(self):
        """X rotation of this transform node.
    ...
    @property
    def rotate_y(self):
        """Y rotation of this transform node.
    ...
    @property
    def rotate_z(self):
        """Z rotation of this transform node.
    ...
    @property
    def scale_x(self):
        """X scale of this transform node.
    ...
    @property
    def scale_y(self):
        """Y scale of this transform node.
    ...
    @property
    def scale_z(self):
        """Z scale of this transform node.
