...
> **Superseded in part (2026-08-30):** the backend boundary and the `ctx`
> build context are replaced by `docs/superpowers/specs/2026-08-30-trigger-simplification-design.md`.
> The declarative module model, fields and `.trg` decisions still stand.
